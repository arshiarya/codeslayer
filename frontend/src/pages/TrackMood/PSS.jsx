...
const PSSAssessment = () => {
  ...
  const calculateScore = () => {
    ...
    Object.keys(answers).forEach((key) => {
      ...
      const scoreValue = answers[key];
      if (positiveItems.includes(questionId)) {
        total += 4 - scoreValue; // reverse scoring
      } else {
        total += scoreValue;
      }
    });
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 space-y-6">
            ...
            <div className={`${interpretation.bg} border-l-4 ${interpretation.border} p-6 rounded-lg`}>
              <h3 className={`text-2xl font-bold ${interpretation.color} mb-2`}>Your Score: {score}/40</h3>
              <p className={`text-lg font-semibold ${interpretation.color} mb-3`}>{interpretation.level}</p>
              <p className="text-gray-700">{interpretation.message}</p>
            </div>

            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg">
              <p className="text-sm text-gray-700">
                <strong>Note:</strong> This assessment is a screening tool and not a diagnostic instrument. If you're
                concerned about your stress levels, please consult with a healthcare professional.
              </p>
            </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-6">
          <div className="text-center space-y-4 mb-8">
            <h1 className="text-4xl font-bold text-[#000459]">Perceived Stress Scale (PSS-10)</h1>
            <p className="text-gray-600">This questionnaire measures your perception of stress over the past month.</p>
