    ...
    return (
        <div className="max-w-6xl mx-auto px-6 py-6">
            ...
            <div className="flex flex-col sm:flex-row items-start justify-between mb-8">
                <div>
                    <h1 className="text-5xl font-semibold text-[#000459] mb-2">Our Community</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                <Link
                    ...
                    className={`p-5 rounded-2xl transition ${activeTab === 'AnnouncementsPage'
                ...
                <Link
                    to="/ListenLearnPage"
                    className={`p-5 rounded-2xl transition ${activeTab === 'ListenLearnPage'
                ...
                <Link
                    to="/ReachOutPage"
                    className={`p-5 rounded-2xl transition ${activeTab === 'ReachOutPage'
